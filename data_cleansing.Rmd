...
outliers. Calling function `Moutlier` directly throws an error. Looks like 
column `studypercap` is causing some problems.

```{r}
# Moutlier(Filter(is.numeric, df)[, -8], quantile = 0.95)
```

This still throws an error!!!! (TO-DO)
