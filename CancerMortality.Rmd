...
Let's start by exploring a linear model with all the variables. We will then
...
```{r}
mm1 <- lm(target_deathrate ~ medincome + incidencerate + pctpubliccoverage + pctpubliccoveragealone + f.pcths18_24 + percentmarried, data= df)
