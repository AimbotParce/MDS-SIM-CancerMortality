...
```{r}
# target_deathrate ~ incidentrate
m1 <- lm(target_deathrate ~ incidentrate, data = df)
summary(m1)
# plot(m1)
boxcox(target_deathrate ~ incidentrate , data=df) #No transformation of the target needed
