...
```{r}
# Most corralated +incidencerate  -medincome +povertypercent  +pcths25_over 
# -pctemployed16_over pctunemployed16_over  pctprivatecoverage pctpubliccoverage
# and pctpubliccoveragealone

model <- lm(target_deathrate ~ percentmarried * incidencerate  + pcths25_over +
            povertypercent + pctbachdeg25_over + pctemployed16_over +
            medincome * pcths18_24 + pctbachdeg18_24 * pcths25_over +
